<div class="payment-methods grid" data-width="1/1">
  ...
  <?php if (collection('payment-methods')->has('credit-card')): ?>
  ...
  <?php endif; ?>
  <?php if (collection('payment-methods')->has('sepa-debit')): ?>
  ...
  <?php endif; ?>
  <?php if (collection('payment-methods')->has('credit-card') || collection('payment-methods')->has('sepa-debit') || collection('payment-methods')->has('sofort')): ?>
